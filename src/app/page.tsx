  ...
  return (
    <>
      ...
      <div className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <PageLayout className='pt-0 md:p-16 sm:pt-8'>
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              <AnimatedText text="イメージを現実に" className="!text-6xl !text-left xl:text-8xl lg:!text-center lg:!text-6xl md:!text-5xl xs:!text-3xl" />
