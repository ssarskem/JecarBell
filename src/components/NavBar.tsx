...
const CustomMobileLink = ({href, title, className="", toggle}: CustomMobileLinkProps): React.ReactElement => {
  const pathname = usePathname()
        ...
        {isOpen ? 
          ...
          >
            <nav className="flex items-center flex-col justify-center">
              ...
              <CustomMobileLink href="/projects" title="プロジェクト" className='' toggle={handleClick} />
              <CustomMobileLink href="/articles" title="記事一覧" className='' toggle={handleClick} />
            </nav>
